...
EM_PAGE_SIZE = 300                    # 概念板块约 400+,300 足够覆盖 Top 板块
...
# 4. 桑基结构与稳定性参数
# ======================================================================
TOP_N = 8                   # 流入/流出各取 Top N 作为「全程固定显示」板块,其余并入平衡节点
...
COLORS = {
    ...
    "balance":   (140, 152, 172),  # 平衡节点:中性灰
    "hub":       (120, 196, 255),  # 主力资金 hub:冷青蓝
...
HUB_LABEL     = "主力资金"
DISCLAIMER    = "数据来源:东方财富,仅作信息整理,不构成投资建议"
WATERMARK     = os.environ.get("WATERMARK", "@资金流监控")   # 预留水印位
